...
public class riwayat extends javax.swing.JFrame {
    ...
    public riwayat() {
        initComponents();
        loadTableData();
        setTitle("Ade Surya Darmawan - 231011701396");
    }
    ...
    public void loadTableData() {
        DefaultTableModel model = new DefaultTableModel(
            new String[] {
                "ID Order", "Isi", "Topping", "Jenis",
                "Wadah", "Saus", "Tingkat Kepedesan", "Jumlah"
            }, 0
        ) {
            @Override
 ...
 public void exportToExcel(JTable table) {
    ...
    try {
        ...
        // Simpan ke file
        FileOutputStream out = new FileOutputStream("hasilexcel/Data_Pesanan.xlsx");
        workbook.write(out);
        out.close();
        workbook.close();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Order", "Isi", "Jenis", "Topping", "Wadah", "Saus", "Tingkat Kepedasan", "Jumlah"
            }
        ));
        ...
        btnExportToExcel.setText("Jadikan Excel");
